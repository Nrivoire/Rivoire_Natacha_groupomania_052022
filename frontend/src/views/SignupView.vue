	...
	<body>
		...
		<div class="container">
			<div class="item">
				...
				<input type="firstname" placeholder="Votre prénom" name="firstname" v-model="firstname" required>
			</div>
			<div class="item"><label for="lastname"><b>Nom</b></label>
				<input type="lastname" placeholder="Votre nom de famille" name="lastname" v-model="lastname" required>
			</div>
			<div class="item">
